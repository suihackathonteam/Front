            ...
            <div className="text-center" style={{ paddingTop: '5rem' }}>
                <div className="card" style={{ maxWidth: '500px', margin: '0 auto', padding: '3rem 2rem' }}>
                    ...
                    <p style={{ color: 'var(--text-color-secondary)' }}>
                        You must have AdminCap permission to access this page.
                    </p>
                </div>
            </div>
        );
    ...
    return (
        <div className="admin-panel fade-in">
            <div className="admin-header">
                <h1>Admin Panel</h1>
                <div className="tabs">
                    <button className={`tab ${activeTab === "workers" ? "tab-active" : ""}`} onClick={() => setActiveTab("workers")}>Worker Cards</button>
                    <button className={`tab ${activeTab === "doors" ? "tab-active" : ""}`} onClick={() => setActiveTab("doors")}>Doors</button>
                    <button className={`tab ${activeTab === "machines" ? "tab-active" : ""}`} onClick={() => setActiveTab("machines")}>Devices</button>
                    <button className={`tab ${activeTab === "awards" ? "tab-active" : ""}`} onClick={() => setActiveTab("awards")}>Give Award</button>
                </div>
            </div>
